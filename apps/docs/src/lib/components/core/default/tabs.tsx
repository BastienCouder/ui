...
const tabsStyles = tv({
  slots: {
    ...
    tab: [
      "cursor-pointer text-center text-muted-fg border-transparent selected:border-border-focus selected:text-fg -mb-px px-2 py-2 text-sm font-medium outline-none transition-colors disabled:text-fg-disabled disabled:cursor-default disabled:selected:border-border-disabled",
