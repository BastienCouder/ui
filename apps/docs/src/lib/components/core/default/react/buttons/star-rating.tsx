...
function StarRating({
  ...
  const variantClassName = starStyles.variants.variant[appliedVariant as keyof typeof starStyles.variants.variant];
   const sizeClassName = starStyles.variants.size[appliedSize as keyof typeof starStyles.variants.size];
   ...
   return (
     <div className={cn('flex items-center cursor-pointer gap-1', wrapperClassName)} {...restWrapperProps}>
