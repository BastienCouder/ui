...
<Bash>
<BashCommand>npx</BashCommand> revueui add multi-select
</Bash>
</TabsContent>
...
<Bash>
<PackageManager/> <p className='flex ml-2'>@radix-ui/react-icons @radix-ui/react-popover @radix-ui/react-primitive @radix-ui/react-use-controllable-state</p>
</Bash>
