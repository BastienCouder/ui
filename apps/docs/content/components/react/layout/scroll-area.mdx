...
<ComponentPreview
  name="demos/components/core/react/layout/scroll-area/default"
  extension={"tsx"}
...
Copy and paste the following code into your project.<br/>
  <ComponentSource
    name={["components/core/default/react/layout/scroll-area"]}
    extension={["tsx"]}
  />
...
<ComponentPreview
  name="demos/components/core/react/layout/scroll-area/sizes"
...
Use the `variant` prop to control the color of the scrollbar.

<ComponentPreview
  name="demos/components/core/react/layout/scroll-area/variants"
  preview={`<div className="rounded-md border p-3">
...
<ComponentPreview
  name="demos/components/core/react/layout/scroll-area/scrollbars"
  preview={`<div className="rounded-md border p-6">
  <ScrollArea
