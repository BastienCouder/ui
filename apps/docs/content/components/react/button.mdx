...
links:
  [
    { href: "/components/angular/button", label: "angular" },
    { href: "/components/vue/button", label: "vue" },
  ]
---

<ComponentPreview
  name="demos/ui/react/button/default"
...
<Bash>
<BashCommand>npx</BashCommand> mbi add button
</Bash>
</TabsContent>
...
<ComponentPreview
  name="demos/ui/react/button/variants"
...
<ComponentPreview
  name="demos/ui/react/button/sizes"
...
<ComponentPreview
  name="demos/ui/react/button/shapes"
...
<ComponentPreview
  name="demos/ui/react/button/prefix-and-suffix"
...
<ComponentPreview
  name="demos/ui/react/button/loading"
...
<ComponentPreview
  name="demos/ui/react/button/disabled"
...
<ComponentPreview
  name="demos/ui/react/button/link-button"
