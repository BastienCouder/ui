...
<ComponentPreview
  name="demos/components/core/react/navigation/toc/default"
...
Copy and paste the following code into your project.<br/>
  <ComponentSource
    name={["components/core/default/react/navigation/toc"]}
    extension={["tsx"]}
  />
...
<ComponentPreview
  name="demos/components/core/react/navigation/toc/nested"
  preview={`<TableOfContents>
    <TableOfContentsTitle>Table of Contents</TableOfContentsTitle>
...
<ComponentPreview
  name="demos/components/core/react/navigation/toc/active"
  preview={`<TableOfContents>
