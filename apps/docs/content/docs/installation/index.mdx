...
<Tabs defaultValue="react" className="mt-12">
<TabsList className="gap-4">
<TabsTrigger value="react" isCard>
 <svg
      role="img"
      viewBox="0 0 24 24"
...
<TabsTrigger value="vue" isCard>
  ...
  >
    <title>Vue</title>
    <path d="M24,1.74H20.57L12,15.29,3.43,1.74H0L12,22.26,24,1.74ZM4.89,3.48H6.79L12,12.42,17.21,3.48h1.9L12,16.81,4.89,3.48Z" />
  </svg>
