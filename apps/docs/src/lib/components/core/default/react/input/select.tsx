...
const selectStyles = tv({
  variants: {
    ...
    variant: {
      primary: 'border-primary bg-primary text-primary-fg hover:bg-primary-hover active:bg-primary-active',
      secondary: 'border-secondary bg-secondary text-secondary-fg hover:bg-secondary-hover active:bg-secondary-active',
      ...
      neutral: 'border-neutral bg-neutral text-fg hover:bg-neutral-hover active:bg-neutral-active',
    },
  },
  defaultVariants: {
    size: 'md',
