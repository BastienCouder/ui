...
<ComponentPreview
  name="demos/ui/react/timeline/default"
  preview={`<Timeline>
...
<<<<<<< HEAD:apps/docs/content/components/react/data-display/timeline.mdx
...
<Steps>
  ...
  <ComponentSource name={["ui/react/timeline"]} extension={["tsx"]} />
  <Step>Update the import paths to match your project setup.</Step>
</Steps>
>>>>>>> registry:apps/docs/content/components/react/timeline.mdx
...
<ComponentPreview
  name="demos/ui/react/timeline/left"
  preview={`<Timeline>
         <TimelineItem status="done">
            <TimelineHeading>Plan!</TimelineHeading>
            <TimelineDot status="done" />
...
<ComponentPreview
  name="demos/ui/react/timeline/right"
  preview={` <Timeline positions="right">
         <TimelineItem status="done">
...
<ComponentPreview
  name="demos/ui/react/timeline/alternating"
  preview={`    <Timeline positions="center">
         <TimelineItem status="done">
            <TimelineHeading side="left">Plan!</TimelineHeading>
            <TimelineDot status="done" />
            <TimelineLine done />
...
<ComponentPreview
  name="demos/ui/react/timeline/lable"
  preview={` <Timeline positions="center">
         <TimelineItem status="done">
            <TimelineHeading side="left">Plan!</TimelineHeading>
