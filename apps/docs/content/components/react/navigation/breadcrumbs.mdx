...
<ComponentPreview
  name="demos/components/core/react/navigation/breadcrumbs/icon"
  preview={`<Breadcrumbs>
  <Breadcrumb href="#">
    <HomeIcon />
    Home
...
<ComponentPreview
  name="demos/components/core/react/navigation/breadcrumbs/router-integration"
