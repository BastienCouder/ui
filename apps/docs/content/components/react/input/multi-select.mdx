...
<ComponentPreview
  name="demos/components/core/react/input/multi-select/default"
  extension={"tsx"}
  preview={`<MultiSelect>
...
```
  ...
  <ComponentSource  name={["components/core/default/react/input/multi-select"]} extension={["tsx"]} />
...
<ComponentPreview name="demos/components/core/react/input/multi-select/with-filter"
preview={`<MultiSelect>
...
<ComponentPreview name="demos/components/core/react/input/multi-select/control-search"
...
<ComponentPreview name="demos/components/core/react/input/multi-select/input-custom"
...
<ComponentPreview name="demos/components/core/react/input/multi-select/limit-count"
...
<ComponentPreview name="demos/components/core/react/input/multi-select/limit-item"
...
<ComponentPreview name="demos/components/core/react/input/multi-select/form"
preview={` <Form {...form}>
