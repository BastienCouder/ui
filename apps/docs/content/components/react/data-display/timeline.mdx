...
<ComponentPreview
  name="demos/components/core/react/data-display/timeline/left"
  preview={`<Timeline>
         <TimelineItem status="done">
            <TimelineHeading>Plan!</TimelineHeading>
            <TimelineDot status="done" />
...
<ComponentPreview
  name="demos/components/core/react/data-display/timeline/right"
...
<ComponentPreview
  name="demos/components/core/react/data-display/timeline/alternating"
...
<ComponentPreview
  name="demos/components/core/react/data-display/timeline/lable"
  preview={` <Timeline positions="center">
         <TimelineItem status="done">
            <TimelineHeading side="left">Plan!</TimelineHeading>
