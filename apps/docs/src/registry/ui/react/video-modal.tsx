...
>(({ className, children, ...props }, ref) => (
  <VideoModalPortal>
    ...
    <DialogPrimitive.Content
      ...
      {...props}
    >
      <div className="relative mx-auto flex w-full h-full items-center justify-center rounded-2xl border border-gray-950/[.1] bg-gray-50/[.2] dark:border-gray-50/[.1] dark:bg-gray-950/[.5]">
        {/* Mobile close button */}
        <CloseIcon isMobile />
