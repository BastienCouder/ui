...
test("resolve import", async () => {
  expect(
    await resolveImport("@/foo/bar", {
      absoluteBaseUrl: "/Users/bastiencouder/Projects/foobar",
      paths: {
        "@/*": ["./src/*"],
  ...
  ).toEqual("/Users/bastiencouder/Projects/foobar/src/foo/bar");
  ...
  ).toEqual("/Users/bastiencouder/Projects/foobar/src/components/foo/bar/baz");
  ...
  ).toEqual("/Users/bastiencouder/Projects/foobar/src/app/components/foo/bar");
  ...
  ).toEqual("/Users/bastiencouder/Projects/foobar/lib/utils");
});
