...
<ComponentPreview
  name="demos/ui/react/scroll-area/default"
  extension={"tsx"}
...
<ComponentPreview
  name="demos/ui/react/scroll-area/sizes"
...
<ComponentPreview
  name="demos/ui/react/scroll-area/variants"
  preview={`<div className="rounded-md border p-3">
...
<ComponentPreview
  name="demos/ui/react/scroll-area/scrollbars"
  preview={`<div className="rounded-md border p-6">
  <ScrollArea
