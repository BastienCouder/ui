...
<ComponentPreview
  name="demos/components/core/react/navigation/breadcrumbs/default"
  preview={`<Breadcrumbs>
...
<Steps>
  ...
  <ComponentSource name={["components/core/default/react/navigation/breadcrumbs"]} extension={["tsx"]}  />
...
Use the `size` prop to control the size of the `Breadcrumbs`. The default variant is `sm`.

<ComponentPreview
  name="demos/components/core/react/navigation/breadcrumbs/sizes"
...
<ComponentPreview
  name="demos/components/core/react/navigation/breadcrumbs/orientation"
...
<ComponentPreview
  name="demos/components/core/react/navigation/breadcrumbs/disabled"
...
<ComponentPreview
  name="demos/components/core/react/navigation/breadcrumbs/composition"
  preview={`<Breadcrumbs>
  <BreadcrumbItem>
