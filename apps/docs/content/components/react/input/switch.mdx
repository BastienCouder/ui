...
<ComponentPreview name="demos/components/core/react/input/switch/variant" 
preview={`<div className="flex items-center space-x-2"> 
...
<ComponentPreview name="demos/components/core/react/input/switch/size" 
preview={`<div className="flex items-center space-x-2"> 
...
<ComponentPreview name="demos/components/core/react/input/switch/shape" 
preview={`<div className="flex items-center space-x-2"> 
...
<ComponentPreview name="demos/components/core/react/input/switch/disabled" 
preview={`<div className="flex items-center space-x-2"> 
